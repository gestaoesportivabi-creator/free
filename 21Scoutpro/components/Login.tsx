        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 py-3 md:py-4">
          <div className="flex items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-3 md:gap-4">
              <a href="https://instagram.com/scout21" target="_blank" rel="noopener noreferrer" className="hidden sm:flex items-center gap-2 px-3 py-1.5 text-white hover:text-zinc-300 text-sm font-normal transition-all hover:bg-zinc-900/50 rounded-lg">
