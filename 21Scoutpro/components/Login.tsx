...
export const Login: React.FC<LoginProps> = ({ onLogin, onBackToHome, onSwitchToRegister }) => {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col relative bg-black overflow-hidden font-sans text-white">
      ...
      <div className="z-20 bg-black/20 backdrop-blur-lg border border-white/10 p-4 sm:p-6 rounded-2xl shadow-[0_0_60px_rgba(0,0,0,0.9)] w-full max-w-sm relative animate-fade-in ring-1 ring-white/5">
        ...
        {/*
          Cadastro agora é self-service. O WhatsApp continua abaixo como canal de
          suporte, mas deixou de ser a única porta de entrada do produto.
        */}
        <div className="mt-4 text-center pt-4 border-t border-white/10 space-y-3">
             ...
             <a
                ...
                className="inline-flex items-center justify-center gap-2 text-[10px] text-zinc-500 hover:text-[#25D366] font-light transition-colors uppercase tracking-widest"
             >
