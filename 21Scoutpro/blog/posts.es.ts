...
export const POSTS_ES: BlogPost[] = [
  ...
  {
    slug: 'plan-editorial-semanal-para-clubes-como-publicar-con-consistencia',
    locale: 'es',
    title: 'Plan editorial semanal para clubes: como publicar con consistencia',
    date: '2026-04-30',
    updatedDate: '2026-04-30',
    readMinutes: 7,
    author: 'Redacción SCOUT21',
    heroEmoji: '📈',
    tags: ['SEO', 'contenido', 'futsal', 'growth'],
    excerpt: 'Playbook práctico para sostener publicación diaria con calidad editorial e impacto en tráfico orgánico.',
    keywords: ['blog futsal', 'seo de contenido', 'publicación diaria', 'tráfico orgánico'],
    translations: {
    ...
    blocks: [
      {
        type: 'p',
        text: 'Este artículo presenta un playbook simple para operar un blog diario sin perder calidad. El foco está en alinear intención de búsqueda, ejecución ágil y revisión mínima antes de publicar.',
      },
      { type: 'h2', text: 'Framework operativo' },
      {
        type: 'list',
        ordered: true,
        items: [
          'Define tema, intención y CTA principal en menos de 10 minutos.',
          'Redacta primero con estructura corta y objetiva.',
          'Revisa SEO on-page y consistencia de enlaces internos.',
          'Publica y recircula en los canales prioritarios.',
        ],
      },
      { type: 'cta-newsletter', text: 'Recibe frameworks semanales de operación editorial.' },
      { type: 'cta-product', text: 'Descubre cómo SCOUT21 acelera tu flujo de contenido.' },
    ],
  },
  {
    slug: 'clusters-de-palabras-clave-en-futsal-cubre-intencion-y-gana-trafico',
    locale: 'es',
    title: 'Clusters de palabras clave en futsal: cubre intención y gana tráfico',
    date: '2026-05-01',
  ...
  {
    slug: 'distribucion-post-publicacion-como-recircular-contenido-y-ampliar-alcance',
    locale: 'es',
    title: 'Distribución post-publicación: cómo recircular contenido y ampliar alcance',
    date: '2026-05-03',
  ...
  {
    slug: 'cadencia-diaria-de-contenido-como-medir-calidad-sin-perder-velocidad',
    locale: 'es',
    title: 'Cadencia diaria de contenido: medir calidad sin perder velocidad',
    date: '2026-05-04',
