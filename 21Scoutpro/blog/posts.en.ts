...
export const POSTS_EN: BlogPost[] = [
  ...
  {
    slug: 'weekly-editorial-plan-for-clubs-how-to-publish-consistently',
    locale: 'en',
    title: 'Weekly editorial plan for clubs: how to publish consistently',
    date: '2026-04-30',
    updatedDate: '2026-04-30',
    readMinutes: 7,
    author: 'SCOUT21 Editorial',
    heroEmoji: '📈',
    tags: ['SEO', 'content', 'futsal', 'growth'],
    excerpt: 'Practical playbook to keep daily publishing consistency while protecting editorial quality and organic growth.',
    keywords: ['futsal blog', 'content seo', 'daily publishing', 'organic traffic'],
    translations: {
      pt: 'plano-editorial-semanal-para-clubes-como-publicar-com-consistencia',
    ...
    blocks: [
      {
        type: 'p',
        text: 'This article provides a simple playbook to run a daily blog without sacrificing quality. The core is aligning search intent, lean execution and a minimum pre-publish quality check.',
      },
      { type: 'h2', text: 'Operational framework' },
      {
        type: 'list',
        ordered: true,
        items: [
          'Define topic, intent and primary CTA in under 10 minutes.',
          'Draft with a short and objective structure first.',
          'Review on-page SEO and internal linking consistency.',
          'Publish and recirculate through priority channels.',
        ],
      },
      { type: 'cta-newsletter', text: 'Get weekly editorial operation frameworks.' },
      { type: 'cta-product', text: 'See how SCOUT21 accelerates your content workflow.' },
    ],
  },
  {
    slug: 'futsal-keyword-clusters-cover-intent-and-grow-traffic',
    locale: 'en',
    title: 'Futsal keyword clusters: cover intent and grow traffic',
    date: '2026-05-01',
    ...
    keywords: ['futsal blog', 'content seo', 'daily publishing', 'organic traffic'],
    translations: {
      pt: 'keyword-clusters-no-futsal-como-cobrir-intencoes-e-ganhar-trafego',
  ...
  {
    slug: 'on-page-seo-for-technical-posts-fast-prepublish-checklist',
    locale: 'en',
    title: 'On-page SEO for technical posts: fast pre-publish checklist',
    date: '2026-05-02',
    ...
    keywords: ['futsal blog', 'content seo', 'daily publishing', 'organic traffic'],
    translations: {
      pt: 'seo-on-page-para-posts-tecnicos-checklist-rapido-antes-de-publicar',
  ...
  {
    slug: 'post-publish-distribution-how-to-recirculate-content-and-expand-reach',
    locale: 'en',
    title: 'Post-publish distribution: recirculate content and expand reach',
    date: '2026-05-03',
    ...
    keywords: ['futsal blog', 'content seo', 'daily publishing', 'organic traffic'],
    translations: {
      pt: 'distribuicao-pos-publicacao-como-recircular-conteudo-e-aumentar-alcance',
  ...
  {
    slug: 'daily-content-cadence-how-to-measure-quality-without-losing-speed',
    locale: 'en',
    title: 'Daily content cadence: measure quality without losing speed',
    date: '2026-05-04',
    ...
    keywords: ['futsal blog', 'content seo', 'daily publishing', 'organic traffic'],
    translations: {
      pt: 'cadencia-diaria-de-conteudo-como-medir-qualidade-sem-perder-velocidade',
